...
def test_publish_pr():
    ...
    assert os.environ.get("LAMIN_API_KEY"), "LAMIN_API_KEY environment variable required"
    ...
    print(f"✓ Successfully published PR to: {url}")
...
def test_publish_pr_with_env_db():
    ...
    print("✓ LAMINDB_INSTANCE environment variable respected")
